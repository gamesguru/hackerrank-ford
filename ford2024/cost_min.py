...
# 3 weeks, 6 costs (4 + 3 + 2 + 1 = 10 possibilities)
...
# 4 weeks, 8 costs (35 possibilities)
...
def optimize() -> Tuple[str, int]:
    ...
    print(f"{len(results)} partitions")
...
print(f"Official: {optimize_official_dynamic_programming_solution()}")
